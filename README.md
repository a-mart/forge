...
- **Archive** — open the Builder Archive view from the sidebar to see archived projects and directly archived sessions, then restore them with a single button. Restoring can immediately reopen the restored target.
