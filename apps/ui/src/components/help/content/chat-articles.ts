...
export const chatArticles: HelpArticle[] = [
  {
    ...
    category: 'chat',
    summary: 'How chat works, including streaming responses, local Desktop browser hosts, workspace rail surfaces, and stopping agents.',
  ...
  },
  {
    ...
    category: 'chat',
    summary: 'Choose Managed Browser or External Chrome and understand local setup, control, limits, and privacy.',
