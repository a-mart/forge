...
const conceptsMultiAgent: HelpArticle = {
  ...
  category: 'concepts',
  summary: 'How managers own outcomes and coordinate workers according to Work Mode.',
...
const conceptsWorkingPlans: HelpArticle = {
  ...
  title: 'Working Plans',
  category: 'concepts',
  summary: 'How managers use concise checklists, optional work graphs, and an inline step inspector for coordinated substantial work.',
