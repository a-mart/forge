...
Non-chat Settings, Stats, Archive, onboarding, Cortex, provider usage, and the mixed sidebar-order setting remain local even while a remote project is selected.
