...
Raw terminal reports remain inspectable in **All**. The manager treats them as evidence rather than inherited conclusions, performs focused acceptance, and publishes an accepted result or material blocker.
