...
Raw terminal worker reports remain inspectable in **All**. The manager treats them as evidence, performs the smallest focused acceptance check needed, and publishes an accepted result or material blocker.
