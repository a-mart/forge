...
- **Grok 4.5 at low reasoning** — A lighter native xAI choice for manager or specialist tasks.
...
- **Grok 4.5 at high reasoning** — The native xAI default configured for more thorough manager or specialist work.
