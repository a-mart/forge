...
- **Extra High (xhigh)** — A level above High when a model also exposes Max, including Claude Opus 5 and Claude Fable 5. Reserve this for the hardest problems: large refactors, subtle bugs, security-sensitive code, architectural planning. Models whose top level is xhigh continue to display this level as Max for compatibility.
