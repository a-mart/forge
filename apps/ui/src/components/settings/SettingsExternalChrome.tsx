        ...
        <div className="rounded-md border border-destructive/30 bg-destructive/10 p-4 text-sm">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground">
                External Chrome requests a broad declared V1 permission set: all websites plus debugger, history, bookmarks, downloads, top-sites, tabs, sessions, navigation, scripting, storage, tab-group, notification, side-panel, and native-messaging, plus optional authority to open downloaded files. Current Local Beta code does not read history, bookmarks, or top sites or open downloaded files. The extension startup shell registers download-change notifications, but the payload ignores them; Forge provides no managed download workflow or saved download artifacts. Forge does not copy Chrome credentials, profile databases, official profile names, bookmarks, history, or top sites. Leased-tab page content, accessibility data, diagnostics, snapshots, arbitrary JavaScript, and authenticated actions can still be exposed during agent turns. Use a dedicated Chrome profile with only the accounts needed for Forge work; do not start with your everyday profile.
              </p>
            </div>
          </div>
        </div>
