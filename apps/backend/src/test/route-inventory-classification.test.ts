...
const ROUTE_INVENTORY: RouteInventoryEntry[] = [
  ...
  { sample: "/api/settings/models", expect: { GET: "admin" } },
  ...
  { sample: "/api/settings/work-plans/enabled", expect: { GET: "admin", PUT: "admin" } },
  { sample: "/api/settings/model-cache-visualization/enabled", expect: { GET: "admin", PUT: "admin" } },
  { sample: "/api/settings/model-overrides", expect: { GET: "admin", PUT: "admin", DELETE: "admin" } },
