...
export function parseClientCommand(raw: RawData): ParsedClientCommand {
  ...
  if (maybe.type === "create_session") {
    ...
    if (sessionPurpose !== undefined && sessionPurpose !== "cortex_review" && sessionPurpose !== "agent_creator") {
      return { ok: false, error: 'create_session.sessionPurpose must be "cortex_review" or "agent_creator" when provided' };
    }
    if (requestId !== undefined && typeof requestId !== "string") {
  ...
  if (maybe.type === "pin_session") {
    ...
    if (typeof agentId !== "string" || agentId.trim().length === 0) {
      return { ok: false, error: "pin_session.agentId must be a non-empty string" };
    }
    if (typeof pinned !== "boolean") {
      return { ok: false, error: "pin_session.pinned must be a boolean" };
    }
    if (requestId !== undefined && typeof requestId !== "string") {
      return { ok: false, error: "pin_session.requestId must be a string when provided" };
    }
  ...
  if (maybe.type === "list_project_agent_references") {
    ...
    if (typeof agentId !== "string" || agentId.trim().length === 0) {
      return { ok: false, error: "list_project_agent_references.agentId must be a non-empty string" };
    }
    if (requestId !== undefined && typeof requestId !== "string") {
      return { ok: false, error: "list_project_agent_references.requestId must be a string when provided" };
    }
  ...
  if (maybe.type === "get_project_agent_reference") {
    ...
    if (typeof agentId !== "string" || agentId.trim().length === 0) {
      return { ok: false, error: "get_project_agent_reference.agentId must be a non-empty string" };
    }
    if (typeof fileName !== "string" || fileName.trim().length === 0) {
      return { ok: false, error: "get_project_agent_reference.fileName must be a non-empty string" };
    }
    if (requestId !== undefined && typeof requestId !== "string") {
      return { ok: false, error: "get_project_agent_reference.requestId must be a string when provided" };
    }
  ...
  if (maybe.type === "set_project_agent_reference") {
    ...
    if (typeof agentId !== "string" || agentId.trim().length === 0) {
      return { ok: false, error: "set_project_agent_reference.agentId must be a non-empty string" };
    }
    if (typeof fileName !== "string" || fileName.trim().length === 0) {
      return { ok: false, error: "set_project_agent_reference.fileName must be a non-empty string" };
    }
    if (typeof content !== "string") {
      return { ok: false, error: "set_project_agent_reference.content must be a string" };
    }
    if (requestId !== undefined && typeof requestId !== "string") {
      return { ok: false, error: "set_project_agent_reference.requestId must be a string when provided" };
    }
  ...
  if (maybe.type === "delete_project_agent_reference") {
    ...
    if (typeof agentId !== "string" || agentId.trim().length === 0) {
      return { ok: false, error: "delete_project_agent_reference.agentId must be a non-empty string" };
    }
    if (typeof fileName !== "string" || fileName.trim().length === 0) {
      return { ok: false, error: "delete_project_agent_reference.fileName must be a non-empty string" };
    }
    if (requestId !== undefined && typeof requestId !== "string") {
      return { ok: false, error: "delete_project_agent_reference.requestId must be a string when provided" };
    }
