...
const DEFAULT_PLAYWRIGHT_POLL_INTERVAL_MS = 10_000
const DEFAULT_PLAYWRIGHT_SOCKET_PROBE_TIMEOUT_MS = 750
const DEFAULT_PLAYWRIGHT_STALE_SESSION_THRESHOLD_MS = 60 * 60 * 1000
