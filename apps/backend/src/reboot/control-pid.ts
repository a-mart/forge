...
const LEGACY_DAEMONIZED_ENV_VAR = "MIDDLEMAN_DAEMONIZED";
const RESTART_PARENT_PID_ENV_VAR = "FORGE_RESTART_PARENT_PID";
const LEGACY_RESTART_PARENT_PID_ENV_VAR = "MIDDLEMAN_RESTART_PARENT_PID";
