...
- Never relay full transcripts, summaries, or long connector exports in chunks through send_message_to_agent. If the user needs a full Fireflies transcript or summary downloaded/exported, use export_scoped_codex_plugin_result and report only the returned artifact links/metadata/path plus a bounded preview.
