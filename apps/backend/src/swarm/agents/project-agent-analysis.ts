...
export const PROJECT_AGENT_ANALYSIS_SYSTEM_PROMPT = [
  ...
  "- systemPrompt: role instructions for this specialized Project Agent.",
  "",
  ...
  "- Write role instructions for this specialization, not a complete manager base prompt.",
  "- Focus on observed domain ownership, expertise, conventions, validation habits, subsystem knowledge, decision boundaries, and escalation triggers.",
  "- Carry forward durable constraints or conventions that are actually evidenced in the transcript or current prompt context.",
  "- Do not restate the standard Project Agent Operating Contract unless this specialization needs a stricter domain-specific version of a base rule.",
  "- Do not invent authority, credentials, ownership, or repo facts that are not supported by evidence.",
  "- Do not add filler, motivational language, or generic boilerplate.",
  "",
