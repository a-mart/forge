...
- Return concise answer-relevant findings in your final response; Forge delivers it to the owning manager automatically.
- Never relay long transcripts, summaries, or connector exports in chunks. If the user needs full Fireflies transcript/summary content, use export_scoped_codex_plugin_result and report only the returned artifact links/metadata/path plus a bounded preview.
