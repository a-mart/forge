...
describe('SwarmManager', () => {
  ...
  it('uses manager and default worker prompts with explicit visibility guidance', async () => {
    ...
    expect(managerPrompt).toContain('Use speak_to_user only for explicit routed delivery: non-web/external targets, rare proactive or mid-turn updates before continuing work, and routed/protected worker-report closeouts. Do not use it for normal final web replies.')
