...
- Repository Project Agent: `<repo>/.forge/project-agents/docs/config.json`, `prompt.md`, optional `reference/*.md`
...
- Repository Project Agent `prompt.md` and `reference/*.md` are live read-only repo inputs while the source is valid.
