...
const UNSAFE_WORK_PLAN_TEXT_PATTERNS = [
  ...
  /[A-Za-z]:[\\/]/,
  /^\\\\/,
  /\b(system prompt|full transcript|assistant transcript|conversation transcript|transcript|tool output|stdout:|stderr:|api key|authorization:\s*bearer|secret)\b/i,
